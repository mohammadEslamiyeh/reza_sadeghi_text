 ...
 */
public class Album_21_show extends AppCompatActivity {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (extras != null) {
                    ...
                    final String this_subject_3 = "album_21_" + my_key_number;
...
////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if (extras != null) {
            ...
            String this_subject = "album_21_" + my_key_number;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.itemFavorites:
                startActivity(new Intent(Album_21_show.this, favorites_show.class));
                return true;
            default:
                return true;
        }
