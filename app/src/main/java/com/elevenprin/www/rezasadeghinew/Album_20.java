 ...
 */
public class Album_20 extends ListActivity {


    public Globals0 global = new Globals0();
    private int song_number = global.album_20_song_number;
    private String[] Album_20_song = new String[song_number];
    private ListView album_20_listview;
    //////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.album_20);





        setListAdapter(new MyAdapter(this, android.R.layout.simple_list_item_1, R.id.textView2, Album_20_song));
        for(int x = 1 ; x <= song_number ; x = x + 1)
        {
            String this_subject = "album_20_song_" + String.valueOf(x);
            int resID = getResources().getIdentifier(this_subject,"string",getPackageName());
            Album_20_song[x-1] = getResources().getString(resID);
        }

        album_20_listview = getListView();
        album_20_listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String p = String.valueOf(position + 1);
                Intent a = new Intent(Album_20.this, Album_20_show.class);
                a.putExtra("key_number", p);
                String c = "album_20_song_" + String.valueOf(position+1);
                a.putExtra("list" , c);
                startActivity(a);
            }
        });
    ...
    private class MyAdapter extends ArrayAdapter<String>
    {
        ...
        public View getView(int position , View convetView , ViewGroup parent)
        {
            ...
            tv.setText(Album_20_song[position]);
            ///////////////////////////////////////////////text size
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.itemFavorites:
                startActivity(new Intent(Album_20.this, favorites_show.class));
                return true;
            default:
                return true;
        }
