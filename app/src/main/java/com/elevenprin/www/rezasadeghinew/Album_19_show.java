 ...
 */
public class Album_19_show extends AppCompatActivity {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (extras != null) {
                    ...
                    final String this_subject_3 = "album_19_" + my_key_number;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if (extras != null) {
            ...
            String this_subject = "album_19_" + my_key_number;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.itemFavorites:
                startActivity(new Intent(Album_19_show.this, favorites_show.class));
                return true;
            default:
                return true;
        }
