 ...
 */
public class Album_2 extends ListActivity{

    public Globals0 global = new Globals0();
    private int song_number = global.album_2_song_number;
    private String[] Album_2_song = new String[song_number];
    private ListView album_2_listview;
    ///////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.album_2);

        setListAdapter(new MyAdapter(this,android.R.layout.simple_list_item_1,R.id.textView2,Album_2_song));

        for(int x = 1 ; x <= song_number ; x = x + 1)
        {
            String this_subject = "album_2_song_" + String.valueOf(x);
            int resID = getResources().getIdentifier(this_subject,"string",getPackageName());
            Album_2_song[x-1] = getResources().getString(resID);
        }

        album_2_listview = getListView();
        album_2_listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String p = String.valueOf(position+1);
                String c = "album_2_song_" + String.valueOf(position+1);
                Intent a = new Intent(Album_2.this , Album_2_Show.class);
    ...
    private class MyAdapter extends ArrayAdapter<String>
    {
        ...
        public View getView(int position , View convetView , ViewGroup parent)
        {
            ...
            tv.setText(Album_2_song[position]);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.itemFavorites:
                startActivity(new Intent(Album_2.this, favorites_show.class));
                return true;
            default:
                return true;
        }
